...
void Credit()
{
    ...
    gotoxy(BATAS_KANAN + 5, 16); cout << "T : ATAS ";
    gotoxy(BATAS_KANAN + 5, 17); cout << "G : BAWAH";
    gotoxy(BATAS_KANAN + 5, 18); cout << "H : KANAN";
    gotoxy(BATAS_KANAN + 5, 19); cout << "F : KIRI";
    gotoxy(BATAS_KANAN + 5, 22); cout << "E-Mail";
    gotoxy(BATAS_KANAN + 5, 23); cout << "firmansy7575@gmail.com";
}
 ...
 float fSpk = 0;
  ...
  system("cls");
    ...
    while(pemainUtama.darah > 0 && (spk - iJarak / 200) > 0)
    {
        ...
        switch (control)
            {
                case 'T' : pemainUtama.keAtas(); break;
                case 'G' : pemainUtama.keBawah(); break;
                case 'H' : pemainUtama.keKanan(); break;
                case 'F' : pemainUtama.keKiri(); break;
            }
    ...
    tulisTengah("Mirorred to TEBEXOpenSource", 18);
    tulisTengah("Created 2018", 19);
    tulisTengah("=========================================", 20);
    tidur(5000);
    getch();
}
